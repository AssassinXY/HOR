...
if __name__ == '__main__':
	...
	parse.add_argument('--train_list', '-tl' , type=str, default = './data_list/train_DF.txt')
	parse.add_argument('--val_list', '-vl' , type=str, default = './data_list/val_DF.txt')
	...
	parse.add_argument('--model_path', '-mp', type=str, default='./output/1_df_c0_299.pkl')
	main()
